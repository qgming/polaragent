...
export function startBackgroundTaskTool(): AgentHarnessTool<ToolContext, typeof startBackgroundTaskParams> {
  return {
    ...
    execute: async (_id, params: Static<typeof startBackgroundTaskParams>, _onUpdate, toolContext, _invocation, _context) => {
...
export function listBackgroundTasksTool(): AgentHarnessTool<ToolContext, typeof listBackgroundTasksParams> {
  return {
    ...
    executionMode: "parallel",
    execute: async (_id, params: Static<typeof listBackgroundTasksParams>, _onUpdate, _toolContext, _invocation, _context) => {
...
export function getBackgroundTaskTool(): AgentHarnessTool<ToolContext, typeof backgroundTaskQueryParams> {
  return {
    ...
    executionMode: "parallel",
    execute: async (_id, params: Static<typeof backgroundTaskQueryParams>, _onUpdate, _toolContext, _invocation, _context) => {
...
export function cancelBackgroundTaskTool(): AgentHarnessTool<ToolContext, typeof backgroundTaskQueryParams> {
  return {
