...
export const enUS = {
  ...
  */
  ...
  settings: {
    ...
    mcpEditorDesc: "stdio runs a local process (npx / uvx / executable), HTTP talks to a remote endpoint",
    mcpServerName: "Name",
    mcpServerNameHint: "When empty the server id is shown instead",
    mcpTransport: "Transport",
    mcpTransportDesc: "Click to switch between stdio (local process) and HTTP (streamable-http endpoint)",
