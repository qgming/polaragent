...
export const zhCN = {
  ...
  */
  ...
  settings: {
    ...
    promptTemplatesEmptyHint: "把带 name 与 description 的 .md 放进数据目录的 prompts 文件夹即可被识别",
  ...
  tools: {
    ...
    browserClick: "点击了页面元素",
    browserClickActive: "正在点击页面元素",
    browserType: "填写了页面表单",
    browserTypeActive: "正在填写页面表单",
    browserScreenshot: "截取了页面",
    browserScreenshotActive: "正在截取页面",
    browserConsole: "读取了页面控制台",
    browserConsoleActive: "正在读取页面控制台",
    browserEvaluate: "执行了页面脚本",
    browserEvaluateActive: "正在执行页面脚本",
    browserPress: "按下了页面按键",
    browserPressActive: "正在按下页面按键",
    browserHover: "悬停到页面元素",
    browserHoverActive: "正在悬停到页面元素",
    browserSelect: "选择了下拉项",
    browserSelectActive: "正在选择下拉项",
    browserWait: "等待页面变化",
    browserWaitActive: "正在等待页面变化",
    browserNetwork: "读取了网络请求",
