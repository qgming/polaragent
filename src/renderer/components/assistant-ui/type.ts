...
export const typeDeck = "text-sm leading-relaxed text-foreground/62";

/** 眉题：给一组内容命名（日期分组、命令面板分组、结果计数） */
export const typeEyebrow = "font-mono text-[11px] tracking-tight text-foreground/35";
