...
function getBackendPath() {
  return projectResourcePath("resources", "builtin", "computeruse", "windows-uia.ps1")
    || path.join(app.getAppPath(), "resources", "builtin", "computeruse", "windows-uia.ps1");
}

function normalizeConfig(next: Record<string, any> = {}) {
  return {
...
function timeoutForAction(action: string, args: Record<string, any> = {}) {
...
async function runComputerUseBatch(payload: Record<string, any> = {}) {
