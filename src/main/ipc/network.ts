...
import { readText } from "../lib/fs-utils.js";
import { errorMessage, normalizeBaseUrl, normalizeWebUrl } from "../lib/http-utils.js";
...
interface ElectronRequestOptions {
  method?: string;
...
function electronRequest(url: string | URL, options: ElectronRequestOptions = {}): Promise<ElectronResponse> {
  return new Promise<ElectronResponse>((resolve, reject) => {
...
function appendOptionalPart(parts: MultipartPart[], key: string, value: unknown) {
