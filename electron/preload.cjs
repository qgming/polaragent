...
contextBridge.exposeInMainWorld("polaragent", {
  ...
  computeruse: {
    ...
    click: (opts) => invoke("cu:click", opts),
    doubleClick: (opts) => invoke("cu:double-click", opts),
    move: (opts) => invoke("cu:move", opts),
    drag: (opts) => invoke("cu:drag", opts),
    scroll: (opts) => invoke("cu:scroll", opts),
    type: (opts) => invoke("cu:type", opts),
    keypress: (opts) => invoke("cu:keypress", opts),
    find: (opts) => invoke("cu:find", opts),
    elementInfo: (opts) => invoke("cu:element-info", opts),
    focus: (opts) => invoke("cu:focus", opts),
    invoke: (opts) => invoke("cu:invoke", opts),
    setValue: (opts) => invoke("cu:set-value", opts),
